...
textinput.addEventListener("keydown", (event) => {
    ...
    newWord = split[index]; // we store the results of the string's index
...
reset.addEventListener("click", () => {
     let empty = " "; // set a variable to null or empty
     output.textContent = empty; // replace the text content to the null variable
     console.log(empty); //debugger!
